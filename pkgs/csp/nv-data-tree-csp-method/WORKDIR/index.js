const api = require("nv-data-tree-csp-apidef");
const lib = api.require_lib();
const l0  = require("nv-data-tree-csp-l0");
const {buildk_to_srchk} = require("nv-data-tree-actdef");
...
const cspop = require("nv-data-tree-csp-op");
