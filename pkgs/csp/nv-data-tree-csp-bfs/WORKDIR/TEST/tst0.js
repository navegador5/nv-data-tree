...
assert.deepStrictEqual(
    ndbfs.$des_bfs_nonleaf_index(idpool,fc,rb,pr,lb,lc,[9,7],[],[]),
    -1
)
assert.deepStrictEqual(
    ndbfs.$des_bfs_leaf_index(idpool,fc,rb,pr,lb,lc,[9,7],[],[]),
    1
)
assert.deepStrictEqual(
    ndbfs.$des_bfs_nonleaf_index(idpool,fc,rb,pr,lb,lc,[4,2],[],[]),
    1
)
assert.deepStrictEqual(
    ndbfs.$des_bfs_nonleaf_index(idpool,fc,rb,pr,lb,lc,[4,7],[],[]),
    -1
)
