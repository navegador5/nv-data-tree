...
const ndgetwo = require("../../index")
assert.deepStrictEqual(
   ndgetwo.$get_with_spl(idpool,fc,rb,pr,lb,lc,[1],[],[[1]]),
   7
)
assert.deepStrictEqual(
   ndgetwo.$get_with_spl(idpool,fc,rb,pr,lb,lc,[1],[],[[0]]),
  2
)
assert.deepStrictEqual(
   ndgetwo.$get_with_spl(idpool,fc,rb,pr,lb,lc,[1],[],[[0,1,1]]),
   6
)

assert.deepStrictEqual(
   ndgetwo.$get_with_spl(idpool,fc,rb,pr,lb,lc,[1],[],[[0,1,2]]),
   0
)
