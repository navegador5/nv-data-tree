...
assert.deepStrictEqual(l0.$is_root(pr,2),true)
assert.deepStrictEqual(l0.$is_root(pr,3),true)
assert.deepStrictEqual(l0.$is_root(pr,4),true)
assert.deepStrictEqual(l0.$is_root(pr,5),true)
assert.deepStrictEqual(l0.$is_root(pr,6),true)
assert.deepStrictEqual(l0.$is_root(pr,7),true)
assert.deepStrictEqual(l0.$is_root(pr,8),true)
assert.deepStrictEqual(l0.$is_root(pr,9),true)
assert.deepStrictEqual(l0.$is_root(pr,10),true)
assert.deepStrictEqual(l0.$is_root(pr,11),true)
assert.deepStrictEqual(l0.$is_root(pr,12),true)
assert.deepStrictEqual(l0.$is_root(pr,13),true)
assert.deepStrictEqual(l0.$is_root(pr,14),true)
assert.deepStrictEqual(l0.$is_root(pr,15),true)
assert.deepStrictEqual(l0.$is_root(pr,16),true)


assert.deepStrictEqual(l0.$is_isolated(fc,pr,1),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,2),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,3),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,4),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,5),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,6),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,7),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,8),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,9),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,10),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,11),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,12),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,13),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,14),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,15),true)
assert.deepStrictEqual(l0.$is_isolated(fc,pr,16),true)

var ch = l0.$append_child(fc,rb,pr,lb,lc,1,2)
assert.deepStrictEqual(ch,2)
...
assert.deepStrictEqual(l0.$is_lstch(rb,2),true)


var ch = l0.$append_child(fc,rb,pr,lb,lc,1,7)
assert.deepStrictEqual(ch,7)
...
var ch = l0.$append_child(fc,rb,pr,lb,lc,2,7)
assert.deepStrictEqual(ch,0)

var ch = l0.$append_child(fc,rb,pr,lb,lc,2,4)
var ch = l0.$prepend_child(fc,rb,pr,lb,lc,2,3)
var ch = l0.$prepend_child(fc,rb,pr,lb,lc,4,6)
var ch = l0.$prepend_child(fc,rb,pr,lb,lc,4,5)

var ch = l0.$append_child(fc,rb,pr,lb,lc,7,8)
var ch = l0.$append_child(fc,rb,pr,lb,lc,7,9)
var ch = l0.$append_child(fc,rb,pr,lb,lc,7,10)

var ch = l0.$append_child(fc,rb,pr,lb,lc,10,16)
var ch = l0.$prepend_child(fc,rb,pr,lb,lc,10,15)
var ch = l0.$prepend_child(fc,rb,pr,lb,lc,10,14)
var ch = l0.$prepend_child(fc,rb,pr,lb,lc,10,13)
var ch = l0.$prepend_child(fc,rb,pr,lb,lc,10,12)
var ch = l0.$prepend_child(fc,rb,pr,lb,lc,10,11)
...
slots[17]=new Node(17)
var ch = l0.$prepend_child(fc,rb,pr,lb,lc,16,17)
assert.deepStrictEqual(l0.$is_lonely(rb,lb,17),true)
